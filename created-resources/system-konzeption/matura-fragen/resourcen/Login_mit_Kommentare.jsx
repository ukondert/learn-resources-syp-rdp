...
// ❌ PROBLEM: Smart- und Dumb-Verantwortung in einer einzigen Komponente
export default function Login({ navigation }) {

  // ❌ State-Management (Aufgabe der Smart Component)
  const [email, setEmail]       = useState('');
  const [password, setPassword] = useState('');
  const [loading, setLoading]   = useState(false);
  const [error, setError]       = useState(null);

  // ❌ API-Aufruf (Aufgabe der Smart Component)
  ...
  // ❌ Vollständige UI-Darstellung (Aufgabe der Dumb Component)
  return (
    <KeyboardAvoidingView
      style={styles.screen}
...
// ❌ Styles ebenfalls in derselben Datei wie API-Logik
