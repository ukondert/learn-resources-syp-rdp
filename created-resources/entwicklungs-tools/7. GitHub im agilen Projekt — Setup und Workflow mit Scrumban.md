...
- ein Projektboard mit klaren **Spalten für den Fortschritt**: Defaultmäßig werden hier die Spalten `ToDo`, `in Progress` und `Done` bereitgestellt.
- **Cards** für einzelne **Aufgaben** (Issues oder Pullrequests)
- zusätzliche **Felder** (Custom Fields) welche wichtige Zusatzinformationen zur Card liefern wie z.B.:
  -  Priorisierung
  -  Art des Issues (z.B. Feature, Bugfix, Refactore)
  -  Kontextzugehörigkeit (z.B. Ausleihkontext, Beschaffungskontext, ...) 
  -  usw.
